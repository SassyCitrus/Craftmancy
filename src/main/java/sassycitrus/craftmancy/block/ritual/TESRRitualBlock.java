...
public class TESRRitualBlock extends TileEntitySpecialRenderer<TileRitualBlock>
{
    @Override
    public void render(TileRitualBlock te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
